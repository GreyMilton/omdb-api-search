...
<template>
  <ul class="scrollbar overflow-auto sm:h-[906px] md:h-[658px] lg:h-[560px]">
    ...
    >
      <article>
        <button
          class="flex w-full items-center gap-3.5 p-7 ring-inset hover:bg-zinc-100 focus-visible:outline-none focus-visible:ring-8 focus-visible:ring-neutral-300 active:bg-zinc-200"
